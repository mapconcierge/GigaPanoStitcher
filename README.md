...
https://mapconcierge.github.io/GigaPanoStitcher/
...
**GigaPanoStitcher** is a fully client-side web application that stitches up to 300 JPEG images shot on a motorized pan/tilt head (GigaPan device) into a single high-resolution panorama — either a flat **Rectangle** or a **360° Equirectangular** image — entirely in your browser.
...
```bash
git clone https://github.com/mapconcierge/GigaPanoStitcher.git
cd GigaPanoStitcher
...
- Code: [CC0 1.0 Universal](LICENSE) (public domain dedication)
...
- Repository: https://github.com/mapconcierge/GigaPanoStitcher
...
**GigaPanoStitcher** は、電動パン/チルト雲台（GigaPan デバイス）で連続撮影した最大 300 枚の JPEG 画像を、ブラウザだけで 1 枚の高解像度パノラマ（平面 **Rectangle** または **360度 Equirectangular**）に合成する、完全クライアントサイドの Web アプリです。
...
- コード: [CC0 1.0 Universal](LICENSE)（パブリックドメイン提供）
...
- リポジトリ: https://github.com/mapconcierge/GigaPanoStitcher
